...
@floto.generator(domain=domain, name='weekDays', version='1')
...
@floto.activity(domain=domain, name='copyFile', version='1')
...
@floto.activity(domain=domain, name='sumLength', version='1')
...
floto.ActivityWorker(task_list='s3_files_worker', domain=domain, 
