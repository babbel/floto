...
class TestTask(object):
    ...
    def test_default_id_same_input(self, task):
        ...
        assert task._default_id(domain='d', name='n',
                                version='v', input=input_1) == task._default_id(domain='d',
                                                                                                      name='n', version='v', input=input_2)

    def test_default_id_different_input(self, task):
        assert not task._default_id(domain='d', name='n', version='v', input='i1') == task._default_id(domain='d', name='n', version='v', input='i2')
