...
class TestJSONEncoder(object):
    ...
    def test_decider_spec(self):
        tasks = [floto.specs.task.ActivityTask(name='n')]
    ...
    def test_child_workflow_dump(self):
        cw = floto.specs.task.ChildWorkflow(workflow_id='wid')
    ...
    def test_child_workflow_loads(self):
        j = {'type':'floto.specs.task.ChildWorkflow', 'id_':'wid'}
    ...
    def test_generator_dumps(self):
        g = floto.specs.task.Generator(activity_id='generator_id')
    ...
    def test_generator_loads(self):
        j = {'type':'floto.specs.task.Generator', 'id_':'generator_id'}
    ...
    def test_type(self):
        task = floto.specs.task.ActivityTask(name='n')
        result = json.loads(json.dumps(task, cls=floto.specs.JSONEncoder))
    ...
    def test_dump_task(self):
        obj = floto.specs.task.ActivityTask()
        s =  floto.specs.JSONEncoder.dump_object(obj)
